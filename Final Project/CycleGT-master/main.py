...
# [Tony] https://github.com/salaniz/pycocoevalcap
...
def prep_data(config, load=""):
    ...
    train_raw = json.load(open(config['train_file'], 'r', encoding='utf-8'))
    ...
    dev_raw = json.load(open(config['dev_file'], 'r', encoding='utf-8'))
    test_raw = json.load(open(config['test_file'], 'r', encoding='utf-8'))
    if len(load)==0:
